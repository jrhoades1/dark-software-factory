---
name: csr-training
description: CSR training and onboarding for American Leak Detection covering call scripts, pricing, scheduling, and service descriptions.
---
...
> **Full insurance workflow:** `references/insurance-workflow.md`
> **ServiceTitan entry for insurance:** `references/servicetitan-insurance.md`
...
Project code: `ALD-CALL-ANALYSIS`
